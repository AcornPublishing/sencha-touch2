...
Ext.application({
    ...
    launch: function() {
        ...
        camera.panel = new Ext.create('Ext.Panel',{
            fullscreen: true,
            html:'<center><img id="img0" src="./img/photo1.png" width="80%" height="30%"><BR><img id="img1" src="./img/photo1.png" width="80%" height="30%"><BR><img id="img2" src="./img/photo1.png" width="80%" height="30%"><BR>',
            items: [
            {
               	docked : 'top',
                xtype: 'toolbar',
