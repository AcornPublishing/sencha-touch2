...
try
{
    ...
    String sql = "select id,subject, content, img from gallery where id > " + ((Integer.parseInt(pageNum)-1) * 5 ) + " and id <= " + (Integer.parseInt(pageNum) * 5) + " order by id";
...
returnStr = psnList;	//"{'data':{" + psnList + "," + err + "}}";
